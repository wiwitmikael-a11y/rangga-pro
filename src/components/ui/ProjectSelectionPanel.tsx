...
const messageTemplates = [
    ...
    { label: 'Kolaborasi Proyek AI', value: "Halo, saya tertarik dengan keahlian Anda di bidang AI dan integrasi berbagai LLM. Saya memiliki proyek [sebutkan proyek] dan ingin mendiskusikan potensi kolaborasi. Apakah Anda bersedia untuk berdiskusi lebih lanjut?" },
    ...
    return (
        <div className="contact-form-container custom-scrollbar">
            ...
            <div className="social-links-container">
                ...
                <a href="https://github.com/atharia-agi" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub Profile">
                    <GitHubIcon />
                </a>
                <a href="https://x.com/Atharia_AGI" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="X Profile">
                    <XIcon />
                </a>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
            {district.subItems?.map(item => (
                <div key={item.id} style={{ ...glassmorphism, padding: '15px', borderRadius: '8px', borderLeft: '3px solid var(--primary-color)' }}>
                    ...
                    <p style={{ color: '#ccc', fontSize: '0.85rem', margin: '0 0 10px 0', lineHeight: 1.5 }}>{item.description}</p>
                    {item.url && (
